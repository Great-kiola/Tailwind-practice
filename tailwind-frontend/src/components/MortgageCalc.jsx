          ...
          <div className='formDiv'>
            <form action="" method="get">
              ...
              <div class="flex mt-2 mb-5">
                ...
                <input type="text" id="website-admin" className="rounded-none rounded-e-lg bg-gray-50 border text-gray-900  w-full text-base font-bold p-2.5 h-12 focus:border-LimeMortgageCalc border-red-500" />
              </div>
